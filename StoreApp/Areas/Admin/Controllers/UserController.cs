...
namespace StoreApp.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            {
                Roles = new HashSet<string>(_manager.AuthService.Roles.Select(r => r.Name))
            });
        }
        ...
        {
            var result = _manager.AuthService.CreateUser(userDto);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Update([FromForm] UserDtoUpdate userDto)
        {
